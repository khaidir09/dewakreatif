    ...
    <div className="relative">
      ...
      >
        <Transition
          show={open}
          as="div"
          className="mt-1 w-[12.5rem] overflow-hidden rounded border border-gray-200 bg-gray-800 p-2 text-xs text-gray-200 shadow-lg transform transition duration-200 ease-out data-[enter]:data-[closed]:-translate-y-1 data-[closed]:opacity-0"
        >
          {content}
        </Transition>
      </div>
